...
class _ChartPageState extends ModularInjector<ChartPage, ChartController>
    with ThemeInjector, TickerProviderStateMixin {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            controller.store.currentTransactions.isEmpty
                ...
                : Column(
                    children: controller.store.expenseTransactions.map((
                      transaction,
                    ) {
                      return Transactions(
      ...
      children: [
        Padding(
          ...
          child: Column(
            crossAxisAlignment: .start,
            children: [
              const ExpenseHeading('Histórico de despesas', size: .xl),
          ...
          () => CarouselItemChart(
            ...
            carouselItems: [
              ...
              Column(
                crossAxisAlignment: .start,
                spacing: spacing.s3x,
                children: controller.store.expenseTransactions
                    .map((transaction) => transaction[4])
                    .toSet()
                    .map((uniqueType) {
                      double value = controller.store.expenseTransactions
                          ...
                          .fold(
                            ...
                            (previousValue, element) =>
                                previousValue + double.parse(element[1]),
                          );
                      return Row(
                        crossAxisAlignment: .start,
                    ...
                    .toList(),
              ).paddingOnly(top: spacing.s9x),
            ],
            pageController: PageController(
              viewportFraction: controller.store.currentPage.value == 0.0
                  ? 0.85
                  : 1.0,
            ),
          ),
