    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 20),
            ExpenseHeading('Saldo disponível', size: ExpenseHeadingSize.xs),
            ExpenseCurrency(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            ExpenseHeading('Despesa', size: ExpenseHeadingSize.xs),
          ],
        ),
        ExpenseCurrency(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            ExpenseHeading('Renda', size: ExpenseHeadingSize.xs),
          ],
        ),
        ExpenseCurrency(
